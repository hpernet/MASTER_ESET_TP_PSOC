// ======================================================================
// TP2_Mesure_Diode.v generated from TopDesign.cysch
// 03/01/2022 at 11:57
...
// IDAC8_v2_0(Current=104, Data_Source=0, Hardware_Enable=false, IDAC_Range=8, IDAC_Speed=0, Initial_Value=13, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_2 (
    iOut,
    data,
    strobe,
...
module top ;
	...
	wire [0:0] tmpOE__POH_net;
	wire [0:0] tmpFB_0__POH_net;
	wire [0:0] tmpIO_0__POH_net;
	wire [0:0] tmpINTERRUPT_0__POH_net;
	electrical [0:0] tmpSIOVREF__POH_net;
	...
	cy_psoc3_pins_v1_10
		...
		POH
		 (.oe(tmpOE__POH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POH_net[0:0]}),
		  .analog({Net_34}),
		  .io({tmpIO_0__POH_net[0:0]}),
		  .siovref(tmpSIOVREF__POH_net),
		  .interrupt({tmpINTERRUPT_0__POH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__POM_net;
	wire [0:0] tmpFB_0__POM_net;
	wire [0:0] tmpIO_0__POM_net;
	wire [0:0] tmpINTERRUPT_0__POM_net;
	electrical [0:0] tmpSIOVREF__POM_net;

	cy_psoc3_pins_v1_10
		#(.id("f8d7a0dc-6634-488b-851c-a1f6b3f84b0e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		POM
		 (.oe(tmpOE__POM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POM_net[0:0]}),
		  .analog({Net_35}),
		  .io({tmpIO_0__POM_net[0:0]}),
		  .siovref(tmpSIOVREF__POM_net),
		  .interrupt({tmpINTERRUPT_0__POM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__POF_net;
	wire [0:0] tmpFB_0__POF_net;
	wire [0:0] tmpIO_0__POF_net;
	wire [0:0] tmpINTERRUPT_0__POF_net;
	electrical [0:0] tmpSIOVREF__POF_net;

	cy_psoc3_pins_v1_10
		#(.id("ea7e5e0c-a114-48ee-bf71-7182a5ce59ee"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		POF
		 (.oe(tmpOE__POF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POF_net[0:0]}),
		  .analog({Net_13}),
		  .io({tmpIO_0__POF_net[0:0]}),
		  .siovref(tmpSIOVREF__POF_net),
		  .interrupt({tmpINTERRUPT_0__POF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MUX_OUT_net;
	wire [0:0] tmpFB_0__MUX_OUT_net;
	wire [0:0] tmpIO_0__MUX_OUT_net;
	wire [0:0] tmpINTERRUPT_0__MUX_OUT_net;
	electrical [0:0] tmpSIOVREF__MUX_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("a1901969-3558-46f8-a0a5-d800664c7515"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MUX_OUT
		 (.oe(tmpOE__MUX_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_OUT_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__MUX_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_OUT_net),
		  .interrupt({tmpINTERRUPT_0__MUX_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam IDAC8_1.Initial_Value = 13;
