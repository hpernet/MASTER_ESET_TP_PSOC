...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_1:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=CapSense_1_CompCH0, )
module Comp_v2_0_0 (
    Vplus,
    CmpOut,
    Vminus,
...
module CapSense_CSD_v3_50_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("858b400b-99e6-4741-9bd7-860af911d99a/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_port_v1_0
		#(.width(1),
		  .siorefwidth(1),
		  .id("858b400b-99e6-4741-9bd7-860af911d99a/dd9c1af8-be5a-4b9e-b10c-b2d9f11dc9fc"),
	...
	cy_clock_v1_0
		#(.id("858b400b-99e6-4741-9bd7-860af911d99a/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("858b400b-99e6-4741-9bd7-860af911d99a/52b807b3-40a8-4a39-b1e7-e18f76c3b871"),
