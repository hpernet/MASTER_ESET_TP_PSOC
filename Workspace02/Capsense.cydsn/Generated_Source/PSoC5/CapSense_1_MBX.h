...
#define CapSense_1_CHECK_SUM      (372u)
...
{       
    ...
    uint8    signal[CapSense_1_TOTAL_SENSOR_COUNT];
    uint8    onMask[CapSense_1_TOTAL_SENSOR_MASK_COUNT];
    
    #if (CapSense_1_TUNING_METHOD == CapSense_1_AUTO_TUNING)
        uint8   fingerThreshold[CapSense_1_WIDGET_CSHL_PARAMETERS_COUNT];
        uint8   noiseThreshold[CapSense_1_WIDGET_CSHL_PARAMETERS_COUNT];
