...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800012Cu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000150u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x0202u);
...
uint8 CYXDATA * const CYCODE AMux_1__addrTable[6] = {
	...
	(uint8 CYXDATA *)CYREG_PRT1_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
